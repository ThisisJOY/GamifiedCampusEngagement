...
class gamifiedCampusEngagement extends Component {
 constructor(props) {
   super(props);
   ...
   this.state = {
     bluetoothState: '',
     // region information
     identifier: 'Nordic Semiconductor ASA',
     uuid: '01122334-4556-6778-899a-abbccddeeff0',
     // uuid: '416C0120-5960-4280-A67C-A2A9BB166D0F',
 ...
 renderRow = rowData => {
   return (
     <View style={styles.row}>
       ...
       <Text>
         Message: {rowData.proximity === 'immediate' ? 'Hi, mayor! You are in an immediate beacon range!' : 'Please move to an immediate beacon range.'}
       </Text>
     </View>
   );
 }
