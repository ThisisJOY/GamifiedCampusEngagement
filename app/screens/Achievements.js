...
import { getAdminAchievements } from '../actions/achievements';
...
class Achievements extends Component {
  static propTypes = {
    ...
    onGetAchievements: PropTypes.func,
    // adminAchievements: PropTypes.array,
  };
  constructor(props) {
    super(props);
...
function mapDispatchToProps(dispatch) {
  return {
    onGetAchievements: () => dispatch(getAdminAchievements()),
  };
}
...
// writeDB() {
//   database.ref('AdminAchievements').set([
//     {
